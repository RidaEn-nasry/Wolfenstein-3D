...
The first was a Wolfenstein 3D clone using C and a minimal graphic library. Wolfenstein 3D was the first FPS ever presented to the world survived using raycasting techniques in not-so-powerfull CPUs back then.<br>
